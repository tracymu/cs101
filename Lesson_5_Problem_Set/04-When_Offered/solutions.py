...
def when_offered(courses,course):
    ...
    for hexamester in courses: # Iterate through the first level within the courses
        if course in courses[hexamester]: # Check if course equals the course you are up to in your iteration.
            ...
            result.append(hexamester) 		# Since you want a list of hexamesters as strings for the result, you can simply append hexamester
    return result